...
from django.contrib.auth.decorators import login_rquired
...
def add_product(request):
    ...
    if not request.user.is_superuser:
        messages.error(request, 'Sorry, onle store owners can do that!')
...
def edit_product(request, product_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, 'Successfylly upated product!')
